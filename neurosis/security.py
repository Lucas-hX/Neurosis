        ...
        async def wrapped_send(message):
            ...
            if message['type'] == 'http.response.start':
                ...
                hs += [(b'x-request-id', request_id.encode()),
                       ...
                       (b'content-security-policy', b"default-src 'none'; img-src 'self'; media-src 'self'; style-src 'self'; base-uri 'none'; frame-ancestors 'none'; form-action 'self'")]
                ...
                elif path in ('/assets/hero-constellation-v1.mp4', '/assets/hero-constellation-v1.webp'):
                    hs += [(b'cache-control', b'public, max-age=31536000, immutable')]
                else:
